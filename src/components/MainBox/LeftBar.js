...
function LeftBar() {
    ...
    return (
        <>
            ...
            {toggle ? "" : <span className="span_bar" onClick={sidebarToggle}>
                <Zoom left cascade>
            ...
            <aside className={toggle ? "aside_left" : ""}>
                ...
                {toggle ? <span className="span_x" onClick={sidebarToggle}>
                    <Zoom right cascade>
                ...
                <article className="left_bar_article">
                    ...
                    <div className="details_div">
                        ...
                        <ul className="left_ul_socialMedia">
                            <li><a href="https://en-gb.facebook.com/sridhar.sri.52687" target="_blank"><i className="fa fa-facebook" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.instagram.com/sridhar_achini/" target="_blank"><i className="fa fa-instagram" aria-hidden="true"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/sridhar-achini-8665a015b/" target="_blank"><i className="fa fa-linkedin" aria-hidden="true"></i></a></li>
                            <li><a href="https://github.com/Sridhar0435" target="_blank"><i className="fa fa-github" aria-hidden="true"></i></a></li>
                            <li><a href="https://twitter.com/AchiniSridhar" target="_blank"><i className="fa fa-twitter" aria-hidden="true"></i></a></li>
                        </ul>
